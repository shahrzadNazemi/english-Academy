...
module.exports.getTutorByUser = (usrId, cb)=> {
    request.get({
        url: `${config.databaseServer}/api/users/tutor/student/${usrId}`,
        headers: {"content-Type": "application/json"},
        json: true
    }, function (err, response, body) {
        if (err) {
...
module.exports.resendVerification = (info, cb)=> {
    request.post({
        url: `${config.databaseServer}/api/users/student/resendVerification`,
        headers: {"content-Type": "application/json"},
        body: info,
        json: true
    }, function (err, response, body) {
...
module.exports.getResultUsr = (usrId, cb)=> {
    request.get({
        url: `${config.databaseServer}/api/result/${usrId}`,
        headers: {"content-Type": "application/json"},
        json: true
    }, function (err, response, body) {
        if (err) {
...
module.exports.deleteResultNotLessonUser = (lsnId , usrId, cb)=> {
    request.delete({
        url: `${config.databaseServer}/api/result/${lsnId}/${usrId}`,
        headers: {"content-Type": "application/json"},
        json: true
    }, function (err, response, body) {
        if (err) {
